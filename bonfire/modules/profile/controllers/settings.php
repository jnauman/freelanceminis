...
class settings extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Profile.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('Profile.Settings.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_profile())
			{
				...
				Template::redirect(SITE_AREA .'/settings/profile');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/profile');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Profile.Settings.Edit');
		...
		{
			$this->auth->restrict('Profile.Settings.Delete');
